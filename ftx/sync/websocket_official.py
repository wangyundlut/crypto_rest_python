...
from websocket_official_manage import WebsocketManager
...
class FtxWebsocketClient(WebsocketManager):
    ...
    def __init__(self) -> None:
        ...
        self._api_key = 'j-xCUQY_AvGcHgzFl7SAX-Rs3fK9pQSULDhumMGp'  # TODO: Place your API key here
        self._api_secret = 'TFqi2N-5IdJ_jl2fBWL3d815ZTJywHKQiMGTiNeL'  # TODO: Place your API secret here
        self._subaccount = 'test00'
    ...
    def _handle_orderbook_message(self, message: Dict) -> None:
        ...
        if computed_result != checksum:
            ...
            # TODO 
            result = self.get_orderbook('BTC-PERP')
            print(f"orderbook {market} bids {result['bids'][0][0]} asks {result['asks'][0][0]}")
    ...
    def _handle_ticker_message(self, message: Dict) -> None:
        ...
        # TODO 
        print(f"ticker {message['market']} bid:{message['data']['bid']} ask:{message['data']['ask']}")
...
if __name__ == '__main__':
    ...
    ftx.connect()
    ftx.get_ticker('BTC-PERP')
    ftx.get_orderbook('BTC-PERP')
