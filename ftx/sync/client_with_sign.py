...
class FtxClient:
    ...
    def get_balances_subaccounts(self, nickname):
    ...
    def get_orders(self, order_id: str) -> dict:
    ...
    def wallet_get_coins(self):
        return self._get('/wallet/coins')
    
    def wallet_get_balances(self) -> List[dict]:
        return self._get('wallet/balances')
    
    def wallet_get_all_balances(self):
        return self._get('wallet/all_balances')
    
    def wallet_get_deposit_address_method(self, coin, method=None):
        # method: erc20, trx(trc20), sol, omni, bep2
        if method: 
            return self._get(f'wallet/deposit_address/{coin}?method={method}')
        return self._get(f'wallet/deposit_address/{coin}')

    def wallet_get_deposit_address(self, ticker: str) -> dict:
        return self._get(f'wallet/deposit_address/{ticker}')

    def wallet_withdraw(self, coin, size, address, tag=None, method=None, password=None, code=None):
        d = {
            'coin': coin,
            'size': size,
            'address': address,
        ...
        return self._post('wallet/withdrawals', d)
