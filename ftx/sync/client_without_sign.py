...
class FtxClient:
    ...
    def get_history_kline(self, market_name, start_time=None, end_time=None, resolution=60):
        path = f"/markets/{market_name}/candles"
        params = {'resolution': resolution, "limit": 2000}
    ...
    def get_funding_rate_current(self, future):
