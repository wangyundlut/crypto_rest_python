...
class huobiRestCoinSwap(Client):

    def __init__(self, api_key, secret_key, host=COIN_FUTURES_HOST, exch="pro"):
        super(huobiRestCoinSwap, self).__init__(api_key, secret_key, host, exch)

    # ===================
    # Market Data Service
    # ===================

    def market_get_contract_info(self, contract_code: str = ""):
        params = {}
        
        if contract_code:
            params["contract_code"] = contract_code

        return self._request("/swap-api/v1/swap_contract_info", GET, params)
